...
if(pathName=="/"){
    Label.servePath = curWwwPath.substring(0,curWwwPath.length-1)
}else{
    Label.servePath = localhostPaht;
}
...
var Util = {
    ...
    checkCode: function () {
        ...
        console.log("invitationcode: "+invitationcode+"/n");
        $.post("checkCode",{"invitationcode":invitationcode},function (data) {
