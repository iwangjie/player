...
!function (e) {
    ...
    i = {
        ...
        uploadTitle: "上传所选文件",
        msgNo: "No",
        msgNoFilesSelected: "未选择任何文件",
        msgCancelled: "取消",
        msgZoomModalHeading: "详细预览",
        msgFileRequired: "请选择要上传的文件",
        msgSizeTooSmall: '上传文件 "{name}" (<b>{size} KB</b>) 太小,必须大于 <b>{minSize} KB</b>.',
        msgSizeTooLarge: '上传文件 "{name}" (<b>{size} KB</b>) 超过最大允许上传大小 <b>{maxSize} KB</b>.',
        msgFilesTooLess: "您最少选择 <b>{n}</b> {files} 上传.",
        msgFilesTooMany: "选择的文件上传数 <b>({n})</b> 超出最大限制 <b>{m}</b>.",
        msgFileNotFound: '文件 "{name}" 未找到!',
        msgFileSecured: '安全限制阻止读取上传文件 "{name}".',
        msgFileNotReadable: '上传文件 "{name}" 无法识别.',
        msgFilePreviewAborted: '中止预览 "{name}" 文件.',
        msgFilePreviewError: '读取 "{name}" 时发生错误.',
        msgInvalidFileName: '不支持的格式或无法识别的上传文件 "{name}".',
        msgInvalidFileType: '无效的上传文件 "{name}". 只支持 "{types}" 格式文件上传.',
        msgInvalidFileExtension: '无效的上传文件 "{name}". 只支持 "{extensions}" 格式文件上传.',
        msgFileTypes: {
            image: "image",
            html: "HTML",
            text: "text",
